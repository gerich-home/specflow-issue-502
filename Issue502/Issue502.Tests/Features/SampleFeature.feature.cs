...
namespace Issue502.Tests.Features
{
...
#line hidden
        ...
        public virtual void TestInitialize()
        {
            if (((TechTalk.SpecFlow.FeatureContext.Current != null) 
                        && (TechTalk.SpecFlow.FeatureContext.Current.FeatureInfo.Title != "SampleFeature")))
            {
                Issue502.Tests.Features.SampleFeatureFeature.FeatureSetup(null);
            }
        }
